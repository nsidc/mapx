 ...
 *======================================================================*/
static const char pmodel_c_rcsid[] = "$Header: /tmp_mnt/FILES/mapx/pmodel.c,v 1.9 2004-01-21 23:54:17 knowlesk Exp $";
...
const char *id_pmodel(void)
{
  return pmodel_c_rcsid;
}
