 ...
 *======================================================================*/
static const char matrix_io_c_rcsid[]="$Header: /tmp_mnt/FILES/mapx/matrix_io.c,v 1.11 2004-01-21 23:54:17 knowlesk Exp $";
...
const char *id_matrix_io(void)
{
  return matrix_io_c_rcsid;
}
