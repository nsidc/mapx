...
static const char matrix_io_h_RCSID[]="$Header: /tmp_mnt/FILES/mapx/matrix_io.h,v 1.2 1997-03-07 19:42:09 brodzik Exp $";

size_t read_matrix (void **data, char *file_name, 
		    int rows, int cols, size_t size);
size_t write_matrix (char *file_name, void **at, 
		     int rows, int cols, size_t size);
