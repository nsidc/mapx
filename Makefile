...
#========================================================================
RCSID = $Header: /tmp_mnt/FILES/mapx/Makefile,v 1.49 2003-05-02 19:33:41 haran Exp $
...
testall : xytest mtest gtest macct gacct
...
cleanexes :
	- $(RM) cdb_edit cdb_list gacct gpmon gridloc gtest irregrid \
...
tar :
	...
	- $(CO) Makefile ppgc.html regrid.c resamp.c irregrid.c \
		...
		mapenum.c gridloc.c \
		$(SRCS) $(HDRS) $(UTESTDIR)/utest.pl $(UTESTDIR)/*.mpp
	$(TAR) cvf $(TARFILE) \
...
mpmon : mapx.c mapx.h maps.c maps.h keyval.o \
		$(PROJECTION_OBJS) $(GCTP_OBJS)
	$(CC) -O -p -DMPMON -o mpmon mapx.c maps.c keyval.o \
		$(PROJECTION_OBJS) $(GCTP_OBJS) $(SYSLIBS)
	$(RM) mapx.o
...
gpmon : grids.c grids.h mapx.c mapx.h maps.c maps.h keyval.o \
		$(PROJECTION_OBJS) $(GCTP_OBJS)
	$(CC) -O -p -DGPMON -o gpmon grids.c mapx.c maps.c keyval.o \
		$(PROJECTION_OBJS) $(GCTP_OBJS) $(SYSLIBS)
	$(RM) grids.o
...
macct : maps.c maps.h mapx.c mapx.h keyval.o \
		$(PROJECTION_OBJS) $(GCTP_OBJS)
	$(CC) -O -DMACCT -o macct mapx.c maps.c keyval.o \
		$(PROJECTION_OBJS) $(GCTP_OBJS) $(SYSLIBS)
	$(RM) mapx.o
...
gacct : grids.c maps.c maps.h mapx.c mapx.h keyval.o \
		$(PROJECTION_OBJS) $(GCTP_OBJS)
	$(CC) -O -DGACCT -o gacct grids.c maps.c mapx.c keyval.o \
		$(PROJECTION_OBJS) $(GCTP_OBJS) $(SYSLIBS)
	$(RM) grids.o
